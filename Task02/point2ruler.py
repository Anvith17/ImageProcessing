...
###rotating the line to make a straight line

image = cv2.imread('line1.png')
...
###Combining both line Image and focus Ruler Image

merged_image = np.vstack((focus_ruler_resized, thin_image))



###Mapping thin point detected to the focus ruler.
